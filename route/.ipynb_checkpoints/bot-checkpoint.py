...
# ============================================================
# ✅ Modelo para NL (LlamaCpp) – respostas curtas
# ============================================================
n_gpu_layers = -1
n_batch = 512
n_ctx = 2048
...
# ============================================================
# ✅ SQL → Linguagem Natural (curto e PT-PT)
# ============================================================
def sql_result_to_natural_language(question: str, sql_query: str, result):
    ...
    # preparar ChatML para o LlamaCpp
    formatted_prompt = (
    ...
    # corta no primeiro fechamento, se existir
...
# ============================================================
# ✅ Funções de alto nível (3 perfis)
# ============================================================
